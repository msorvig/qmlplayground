...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6WebViewQuickTargetsPrecheck.cmake")

if(NOT __qt_WebViewQuick_skip_include_targets_file AND Qt6WebViewQuick_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6WebViewQuickExtraProperties.cmake"
        OPTIONAL)
    set(__qt_WebViewQuick_targets_file_included ON)
endif()
...
if (Qt6WebViewQuick_FOUND
    ...
    find_package(Qt6WebViewQuickPrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_WebViewQuick_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::WebViewQuick)
    ...
    if(NOT DEFINED Qt6WebViewQuick_NOT_FOUND_MESSAGE)
        ...
        if(__qt_WebViewQuick_skip_include_targets_file)
            string(APPEND Qt6WebViewQuick_NOT_FOUND_MESSAGE
                "Possibly due to __qt_WebViewQuick_skip_include_targets_file being set to TRUE and thus "
